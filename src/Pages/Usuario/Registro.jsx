...
import imagenRegistro from "../../assets/imagen-registro.jpeg";
import cajaCarton from "../../assets/caja-de-carton.jpg";
      ...
      <div className="flex flex-col justify-center items-center lg:w-2/4 mr-10 md:flex-row ">
        ...
        <div>
          ...
          >
            ...
            <div className="mb-5">
              <label htmlFor="repitepassword" className="font-medium">
                Repite tu Password
              </label>
              <input
                type="password"
